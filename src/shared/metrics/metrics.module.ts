...
import { IMetricsModuleOptions } from './metrics-module-options.interface';
 ...
 * - transport: `GET /metrics` exposition controller + the global HTTP
 ...
 * @example
 * ```ts
 * MetricsModule.forRoot({ appLabel: 'my-service' })
 * ```
 */
@Module({})
export class MetricsModule {
  static forRoot(options: IMetricsModuleOptions): DynamicModule {
    return {
      ...
      imports: [
        ...
        PrometheusModule.register({
          ...
          defaultLabels: { app: options.appLabel },
        }),
      ],
      providers: [
        ...METRIC_PROVIDERS,
