 ...
 * class must still be registered in its owning module's providers (e.g. in
 * an `MCP_TOOLS` array). At bootstrap, `McpToolRegistry` discovers every
 * provider carrying this metadata and registers it on the per-request MCP
 * server.
 */
